...
export default function Section08({ effectsEnabled }: Section08Props) {
  const pigsRunDurationMs = 2200;
  const pigsRunFadeDurationMs = 1000;
    ...
    const startPlayback = () => {
      const startFade = () => {
        ...
        const tick = (now: number) => {
          const progress = Math.min((now - fadeStartTime) / pigsRunFadeDurationMs, 1);
      ...
      runningFadeTimeoutRef.current = setTimeout(startFade, pigsRunDurationMs);
    };
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: "url('/img/Section08/bg-section08.webp')",
        }}
        aria-hidden="true"
      />
      ...
      >
        <div className={`section--08-wolf-stage${wolfVisible ? " section--08-wolf-stage--visible" : ""}`}>
          ...
          <img
            ...
            src="/img/Section08/wolf_blowing.webp"
            alt="Lobo soplando"
            draggable={false}
          />
        </div>
        <img
          ...
          src={isBlowing ? "/img/Section08/wood_house_destroyed.webp" : "/img/Section08/wood_house.webp"}
          alt="Casa de madera"
          draggable={false}
        />
        <img
          ...
          src="/img/Section08/pig1_2_suprised.webp"
        ...
        <img
          ...
          src="/img/Section08/pig1-2_run.webp"
